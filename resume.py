...
# File upload
upload_file = st.file_uploader("Upload your resume (PDF)", type=["pdf"], help="Please upload a PDF file of your resume.")


# Job description input
job_description = st.text_area("Enter the job description (optional)", help="Provide the job description to tailor your resume analysis.")
...
st.sidebar.markdown("""
- [Resume Writing Tips](https://careerhelp.resumegemini.com/careertips/7-resume-writing-tips-to-get-noticed-in-2024/?msclkid=b130cabc60f11367197cad7f67a9e4c1)
